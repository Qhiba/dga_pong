...
public class GameManager : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        {
            //Ketika tombol restart diktekan, reset skor kedua pemain...
            player1.ResetScore();
            player2.ResetScore();
        ...
        //Jika isDebugWindowShown == true, tampilkan text area untuk debug windo.
        ...
        //Toggle nilai debug window ketika pemain mengklik tombol ini.
        if (GUI.Button(new Rect(Screen.width / 2 + 5, 35, 120, 53), "EXIT"))
        {
            Application.Quit();
        }
    }
