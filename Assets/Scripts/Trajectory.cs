...
public class Trajectory : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach(RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
            ...
            {
                //Garis lintasan akan digambarkan dari titik tengah bola saat ini ke titik tengah bola pada saat tumbukan,
                ...
                //Gambar garis lintasan dari titik tengah bola saat ini ke titik tengah bola saat bertumbuk
